...
<%
  ...
  ArrayList  Acc_Sale_Day    = (ArrayList)session.getAttribute("Acc_Sale_Day_" + Sid);
  int        sn         = 0; 
  String     Manage_List = "";
...
<form name="Acc_Sale_Day"  action="Acc_Sale.do" method="post" target="mFrame">
<div id="down_bg_2">
				...
				<tr height='30' valign='middle'>
							 <td width='100%' align='center' colspan=2>
										<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
												...
												<%
												 if(Acc_Sale_Day != null)
												 {
														Iterator iterator = Acc_Sale_Day.iterator();
														while(iterator.hasNext())
														{
							     		 	...
							     		 	<tr>
													 <td colspan="7" class="table_deep_blue" >
											 			  <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" >
										    			    <tr valign="bottom">
										      			       <td nowrap><%=currStatus.GetPageHtml("Acc_Sale_Day")%></td>
										    			    </tr>			    		
														  </table>
													 </td>
												</tr>
...
function doSelect()
{
		Acc_Sale_Day.BTime.value = Acc_Sale_Day.BDate.value + " 00:00:00";
		Acc_Sale_Day.submit();
}
...
function GoPage(pPage)
{
	...
	Acc_Sale_Day.BTime.value = Acc_Sale_Day.BDate.value + " 00:00:00";
	Acc_Sale_Day.CurrPage.value = pPage;
	Acc_Sale_Day.submit();
}

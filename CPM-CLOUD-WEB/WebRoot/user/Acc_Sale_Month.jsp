...
{	
	...
	if(confirm("确定导出?"))
  {
		if(window.XMLHttpRequest)
	  {
		...
		var url = "Acc_Sale_Month_Export.do?Sid=<%=Sid%>&Id="+window.parent.frames.lFrame.document.getElementById('id').value+"&Level="+window.parent.frames.lFrame.document.getElementById('level').value+"&BTime="+Acc_Sale_Month.BDate.value+" 00:00:00"+"&CurrPage=<%=currStatus.getCurrPage()%>";
